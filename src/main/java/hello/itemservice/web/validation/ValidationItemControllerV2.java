...
//            model.addAttribute("errors", errors); 자동으로 view에 같이넘어간다.
            return "validation/v2/addForm";
        }
...
//            errors.put("quantity", "수량은 최대 9,999 까지 허용합니다.");
        ...
        if (item.getPrice() != null && item.getQuantity() != null) {
            ...
            if (resultPrice < 10000) {
//                errors.put("globalError", "가격 * 수량의 합은 10,000원 이상이어야합니다. 현재 값 = " + resultPrice);
                bindingResult.addError(new ObjectError("item", new String[]{"totalPriceMin"}, new Object[]{10000,resultPrice}, "가격 * 수량의 합은 10,000원 이상이어야합니다. 현재 값 = " + resultPrice));
            }
        }
